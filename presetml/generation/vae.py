...
def run_vae(args, data):
    ...
    batch_size, decoder, encoder, epochs, inputs, original_dim, outputs, vae, \
        x_test, x_train, y_test, z_log_var, z_mean = build_vae(x_train, x_test,
                                                               y_test)
            ...
            for j, xi in enumerate(grid_x):
                ...
                for preset in x_decoded:
                    ...
                    ableton_analog.write_zipped_preset(
                        ...
                        f'zsample-({yi},{xi})-{uuid.uuid4()}.adv', xml)
...
def build_vae(x_train, x_test, y_test):
    ...
    return batch_size, decoder, encoder, epochs, inputs, original_dim, \
        outputs, vae, x_test, x_train, y_test, z_log_var, z_mean
